...
public class Sheet2SearchForm implements Serializable {
	...
	/*
	 * info=ColInfo(fNum=5, colName=DecimalField, msgKey=Sheet2.decimalfield,
	...
	/*
	 * info=ColInfo(fNum=1, colName=id, msgKey=Sheet2.id, vName=id, type=Integer,
	...
	/*
	 * info=ColInfo(fNum=3, colName=IntegerField, msgKey=Sheet2.integerfield,
